...
| `GET /view` | In-browser statement reader: the same crypto as `umbra view` compiled to WASM — keys never leave the page, results verified against on-chain commitments |
